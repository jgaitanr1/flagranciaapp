    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="actions">
                ...
                <Button icon="pi pi-sign-out" className="p-button-rounded p-button-outlined p-button-warning" onClick={() => confirmDeleteProduct(rowData)} />
            </div>
        );
    }
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Detalle Detenidos" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label htmlFor="name">Nombre</label>
                            <InputText id="nombre" name="nombre" value={product.nombre} onChange={(e) => onInputChange(e, 'nombre')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="direccion">Direccion (Direccion / Distrito / Provincia / Pais)</label>
                            <InputText id="direccion" name="direccion" value={product.direccion} onChange={(e) => onInputChange(e, 'direccion')} required />
                        </div>
                    </Dialog>
